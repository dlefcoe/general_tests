...
print('Example 4: how to use a decorator')
...
def calculate_time(func):
	...
	def inner1(*args, **kwargs):
		...
		print("Total time taken in ", func.__name__, 'is', round(end - begin,2), 'seconds.')
...
In all the above examples the functions did not return anything so there was not any issue, 
but one may need the returned value.
'''

print('Example 6: parsing args into the function and getting a return')
def hello_decorator(func):
    def inner1(*args, **kwargs):
