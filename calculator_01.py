...
example of tkinter for LEM Solutions
...
root.iconbitmap("calculator-icon_34473.png")
...
button_add: tk.Button = tk.Button(
    root, text="+", padx=30, pady=30, command=button_add
)
button_subtract: tk.Button = tk.Button(
    root, text="-", padx=30, pady=30, command=button_subtract
)
button_multiply: tk.Button = tk.Button(
    root, text="*", padx=30, pady=30, command=button_multiply
)
button_divide: tk.Button = tk.Button(
    root, text="/", padx=30, pady=30, command=button_divide
)

button_equal: tk.Button = tk.Button(
    root, text="=", padx=69, pady=30, command=button_equal
)
button_clear: tk.Button = tk.Button(
    root, text="clear", padx=60, pady=30, command=button_clear
)
...
my_label2 = tk.Label(root, text="LEM Solutions calculator").grid(row=4, column=5)
